...
CREATE TABLE `ParametrosAnalise` (
    ...
    `unidadeResultado` VARCHAR(191) NULL DEFAULT '',
...
CREATE TABLE `Amostra` (
    ...
    `prazoInicioFim` VARCHAR(191) NOT NULL DEFAULT 'Aguardando',
    `dataRecepcao` VARCHAR(191) NOT NULL DEFAULT 'Aguardando',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
CREATE TABLE `LaboratorioExterno` (
    ...
    `telefone` VARCHAR(191) NULL DEFAULT '',
...
CREATE TABLE `AmostraLabExterno` (
    ...
    `elementosAnalisados` JSON NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `TipoAnalise` ADD CONSTRAINT `TipoAnalise_amostraId_fkey` FOREIGN KEY (`amostraId`) REFERENCES `Amostra`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
